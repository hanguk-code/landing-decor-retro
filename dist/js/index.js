...
$('.menu__dropdown').on('click', function() {
  ...
  // Menu opener hamburger
	...
	$(".zoom_01").elevateZoom({zoomWindowWidth:200, zoomWindowHeight:200, scrollZoom:true}); 
...
$("#img_01").elevateZoom({gallery:'swiper-wrapper', cursor: 'pointer', galleryActiveClass: 'active', imageCrossfade: true, loadingIcon: 'http://www.elevateweb.co.uk/spinner.gif'}); 
