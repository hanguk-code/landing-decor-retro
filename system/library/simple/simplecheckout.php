...
class SimpleCheckout extends Simple {
    ...
    public function isBlockHidden($block = '') {
        if (!$block) {
            if ($this->hasBlock($this->_block)) {
                $hidden = $this->customer->isLogged() ? $this->getSettingValue('hideForLogged') : $this->getSettingValue('hideForGuest');
            } else {
                $hidden = true;
            }
        } else {
    ...
    public function isAddressSame() {
        if ($this->displayAddressSame()) {
            ...
            $shippingAddressHidden = $this->isBlockHidden('shipping_address');
            $paymentAddressHidden = $this->isBlockHidden('payment_address');
            if (($shippingAddressHidden && $paymentAddressHidden) || (!$paymentAddressHidden && $shippingAddressHidden)) {
                return true;
            } else {
                return false;
            }
    ...
    public function getPaymentAddress() {
        if ($this->isBlockHidden('payment_address')) {
        ...
        if (!$this->isFieldUsed('payment_address', 'firstname') || !$this->isFieldUsed('payment_address', 'lastname')) {
            if (!$this->customer->isLogged()) {
                ...
                $customerInfo['firstname'] = $this->customer->getFirstName();
                $customerInfo['lastname']  = $this->customer->getLastName();
            }
        }
        ...
        $fieldsInfo['firstname']  = $this->isFieldUsed('payment_address', 'firstname') ? $this->getFieldValue('firstname') : (isset($customerInfo['firstname']) ? $customerInfo['firstname'] : '');
        $fieldsInfo['lastname']   = $this->isFieldUsed('payment_address', 'lastname') ? $this->getFieldValue('lastname') : (isset($customerInfo['lastname']) ? $customerInfo['lastname'] : '');
    ...
    public function getShippingAddress() {
        ...
        $fieldsInfo['address_id'] = $addressId;
        $fieldsInfo['firstname']  = $this->isFieldUsed('shipping_address', 'firstname') ? $this->getFieldValue('firstname') : (isset($customerInfo['firstname']) ? $customerInfo['firstname'] : '');
        $fieldsInfo['lastname']   = $this->isFieldUsed('shipping_address', 'lastname') ? $this->getFieldValue('lastname') : (isset($customerInfo['lastname']) ? $customerInfo['lastname'] : '');
        $fieldsInfo['company']    = $this->getFieldValue('company');
        $fieldsInfo['company_id'] = $this->getFieldValue('company_id');
        $fieldsInfo['tax_id']     = $this->getFieldValue('tax_id');
        $fieldsInfo['address_1']  = $this->getFieldValue('address_1');
